...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "body {\n  background-color: black;\n}\nbody button {\n  font-family: \"Manufab\";\n  font-variation-settings: \"wght\" 200;\n  background-color: white;\n  cursor: pointer;\n  outline: none;\n  flex-shrink: 0;\n  font-size: 30px;\n  height: calc(100vh - 16px);\n  width: calc(100vw - 16px);\n  padding: 0;\n  border: none;\n  border-radius: 20px;\n}\nbody button:hover, body button:focus {\n  transform: scale(1.01);\n}\nbody button:active {\n  transform: scale(0.99);\n}", "",{"version":3,"sources":["webpack://./src/styles/core.scss"],"names":[],"mappings":"AAAA;EACE,uBAAA;AACF;AAAE;EACE,sBAAA;EACA,mCAAA;EACA,uBAAA;EACA,eAAA;EACA,aAAA;EACA,cAAA;EACA,eAAA;EACA,0BAAA;EACA,yBAAA;EACA,UAAA;EACA,YAAA;EACA,mBAAA;AAEJ;AADI;EAEE,sBAAA;AAEN;AAAI;EACE,sBAAA;AAEN","sourcesContent":["body {\n  background-color: black;\n  button {\n    font-family: \"Manufab\";\n    font-variation-settings: \"wght\" 200;\n    background-color: white;\n    cursor: pointer;\n    outline: none;\n    flex-shrink: 0;\n    font-size: 30px;\n    height: calc(100vh - 16px);\n    width: calc(100vw - 16px);\n    padding: 0;\n    border: none;\n    border-radius: 20px;\n    &:hover,\n    &:focus {\n      transform: scale(1.01);\n    }\n    &:active {\n      transform: scale(0.99);\n    }\n  }\n}\n"],"sourceRoot":""}]);
// Exports
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ Lifeform)
/* harmony export */ });
/* harmony import */ var _data_planetarium_json__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./data/planetarium.json */ "./src/js/data/planetarium.json");
/* harmony import */ var _data_faunapedia_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./data/faunapedia.json */ "./src/js/data/faunapedia.json");
...
class Lifeform {
  constructor(age, species, homeworld) {
    this.age = age
    this.species = _data_faunapedia_json__WEBPACK_IMPORTED_MODULE_1__[species]
    this.homeworld = _data_planetarium_json__WEBPACK_IMPORTED_MODULE_0__[homeworld]
  }

  cyclesSeenOf(planetName) {
    const earthAge = this.age * this.homeworld.solarLapTime
    return earthAge / _data_planetarium_json__WEBPACK_IMPORTED_MODULE_0__[planetName].solarLapTime
  }
  ...
  cyclesYetToSeeOf(planetName) {
    ...
    const observedPlanet = _data_planetarium_json__WEBPACK_IMPORTED_MODULE_0__[planetName]
  ...
  stateAgeOn(planetName) {
    const planet = _data_planetarium_json__WEBPACK_IMPORTED_MODULE_0__[planetName]
...
"use strict";
module.exports = JSON.parse('{"HUMAN":{"id":"HUMAN","adj":"Human","terranLifeExpectancy":{"average":72,"record":122}},"CAT":{"id":"CAT","adj":"Feline","terranLifeExpectancy":{"average":15,"record":38}},"DOG":{"id":"DOG","adj":"Canine","terranLifeExpectancy":{"average":10,"record":29}},"BIRD":{"id":"BIRD","adj":"Avian","terranLifeExpectancy":{"average":10,"record":120}},"SPIDER":{"id":"SPIDER","adj":"Arachnid","terranLifeExpectancy":{"average":1,"record":46}}}');

/***/ }),

/***/ "./src/js/data/planetarium.json":
/*!**************************************!*\
  !*** ./src/js/data/planetarium.json ***!
  \**************************************/
/***/ ((module) => {
...
"use strict";
module.exports = JSON.parse('{"MERCURY":{"id":"MERCURY","adj":"Mercurian","solarLapTime":0.24},"VENUS":{"id":"VENUS","adj":"Venusian","solarLapTime":0.62},"EARTH":{"id":"EARTH","adj":"Terran","solarLapTime":1},"MARS":{"id":"MARS","adj":"Martian","solarLapTime":1.88},"JUPITER":{"id":"JUPITER","adj":"Jovian","solarLapTime":11.86}}');
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "simpleOrdinal": () => (/* binding */ simpleOrdinal),
...
/* harmony import */ var _Lifeform__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Lifeform */ "./src/js/Lifeform.js");
/* harmony import */ var _data_faunapedia_json__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./data/faunapedia.json */ "./src/js/data/faunapedia.json");
/* harmony import */ var _data_planetarium_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./data/planetarium.json */ "./src/js/data/planetarium.json");
// STYLE
...
const PLANET_NAMES = Object.keys(_data_planetarium_json__WEBPACK_IMPORTED_MODULE_6__)
const SPECIES_NAMES = Object.keys(_data_faunapedia_json__WEBPACK_IMPORTED_MODULE_5__)

const yourSpecies = (0,_util__WEBPACK_IMPORTED_MODULE_3__.whichever)(SPECIES_NAMES)
const yourPlanet = (0,_util__WEBPACK_IMPORTED_MODULE_3__.whichever)(PLANET_NAMES)
const yourAge = (0,_util__WEBPACK_IMPORTED_MODULE_3__.d)(100)
const ageOrdinal = (0,_util__WEBPACK_IMPORTED_MODULE_3__.simpleOrdinal)(yourAge)

const lifeform = new _Lifeform__WEBPACK_IMPORTED_MODULE_4__.default(yourAge, yourSpecies, yourPlanet)
...
jquery__WEBPACK_IMPORTED_MODULE_2___default()(() => {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_2___default()(`<button/>`).text(`OK`).appendTo(`body`)
  jquery__WEBPACK_IMPORTED_MODULE_2___default()(`button`).on(`click`, () => {
    if (statements.length > 0) {
      console.log(statements.shift())
    } else {
      jquery__WEBPACK_IMPORTED_MODULE_2___default()(`button`).on(`mousedown`, () => {
